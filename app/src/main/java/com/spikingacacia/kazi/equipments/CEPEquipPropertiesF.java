...
public class CEPEquipPropertiesF extends Fragment
{
   ...
   // private OnFragmentInteractionListener mListener;
    ...
    private String url_update= LoginActivity.base_url+"update_properties_matrix.php";
    ...
    public static CEPEquipPropertiesF newInstance(String param1, String param2)
    {
        CEPEquipPropertiesF fragment = new CEPEquipPropertiesF();
            ...
            while (iterator.hasNext())
            {
                ...
                try
                {
                    ...
                    if(success==1)
                    {
                        ...
                        {
                            for(int d=0; d<values[c].length; d++)
                                LoginActivity.equipmentsMatrix[c][d]=values[c][d];
                        }
