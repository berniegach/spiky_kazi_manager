...
public class CEPNotificationsF extends Fragment
{
    ...
    private String url_update= LoginActivity.base_url+"update_c_notificationsequipments.php";
    ...
    public static CEPNotificationsF newInstance(String param1, String param2)
    {
        CEPNotificationsF fragment = new CEPNotificationsF();
   ...
   /* @Override
    ...
    private void addLayouts()
    {
        ...
        String notifications=LoginActivity.contractorAccount.getNotificationsEquipments();
        ...
        while (iterator.hasNext())
        {
            ...
            equipLayout.addView(textCount);
            equipLayout.addView(textContent);
            equipLayout.addView(countLayout);
            //add layout to main
            layout.addView(equipLayout);
    ...
    public class UpdateTask extends AsyncTask<Void, Void, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            try
            {
                ...
                if(success==1)
                {
                    LoginActivity.contractorAccount.setNotificationsEquipments(notifications);
                   return true;
                }
                else
                {
