...
package com.spikingacacia.kazi.skulist;
...
import com.spikingacacia.kazi.skulist.row.SkuRowData;
import com.spikingacacia.kazi.skulist.row.UiManager;
...
public class AcquireFragment extends DialogFragment
{
    ...
    //private QuitThisFragment quitThisFragment;
    ...
    public void onAttach(Context context)
    {
        ...
        if (context instanceof QuitThisFragment)
        {
            quitThisFragment = (QuitThisFragment) context;
        } else
        {
   ...
   /* public interface QuitThisFragment
    {
        void quit();
    }*/
