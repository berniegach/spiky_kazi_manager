 ...
 */
public class CREMissingOPropsF extends Fragment
{
    ...
    public static CREMissingOPropsF newInstance()
    {
        CREMissingOPropsF fragment = new CREMissingOPropsF();
        return fragment;
    }
    public CREMissingOPropsF()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View view=inflater.inflate(R.layout.f_cremissing_oprops, container, false);
           ...
           /* if(which=='m')
            {
                ...
                if(missing[count]>0)
                {
                    ...
                    tempColorsRes.add(getColor(count % 10));
                }
            }*/
                if(which=='j')
                {
