 ...
 */
public class CREMissingPropsF extends Fragment
{
    ...
    public static CREMissingPropsF newInstance()
    {
        CREMissingPropsF fragment = new CREMissingPropsF();
        return fragment;
    }
    public CREMissingPropsF()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View view=inflater.inflate(R.layout.f_cremissing_props, container, false);
