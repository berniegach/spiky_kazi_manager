 ...
 */
public class CRPMissingMQualsF extends Fragment
{
    ...
    public static CRPMissingMQualsF newInstance()
    {
        CRPMissingMQualsF fragment = new CRPMissingMQualsF();
        return fragment;
    }
    public CRPMissingMQualsF()
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View view=inflater.inflate(R.layout.f_crpmissing_mquals, container, false);
